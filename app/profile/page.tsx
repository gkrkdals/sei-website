...
function InfoRow({ icon: Icon, label, value, children }: any) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-[200px,1fr] gap-4 border-b border-stone-100 dark:border-slate-700 py-6 last:border-b-0 hover:bg-blue-50/50 dark:hover:bg-slate-700/30 px-4 rounded-xl transition-colors">
      <div className="flex items-center gap-3 text-stone-900/80 dark:text-stone-300">
        <Icon className="w-6 h-6 text-blue-700 dark:text-blue-400 shrink-0" />
        <span className="font-semibold text-lg">{label}</span>
      </div>
      <div className="text-stone-800 dark:text-stone-300 text-lg leading-relaxed pt-1 md:pt-0">
        {value}
        {children}
      </div>
    </div>
    ...
    <div className="w-full bg-stone-50/30 dark:bg-slate-950 py-16 md:py-24 pt-20">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <header className="mb-16 md:mb-20 text-center md:text-left">
          ...
          <p className="mt-6 text-xl text-stone-600 dark:text-stone-400 max-w-3xl leading-relaxed">
        ...
        <main className="bg-white dark:bg-slate-800 p-8 md:p-12 rounded-3xl shadow-xl shadow-blue-950/5 dark:shadow-black/50 border border-stone-100 dark:border-slate-700">
          <div className="space-y-2">
            ...
            >
              ...
              <a 
                href="/location" 
                className="inline-block mt-2 text-sm text-blue-700 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300 font-medium underline underline-offset-4"
              >
                지도 보기 &rarr;
              </a>
            </InfoRow>
            ...
            <InfoRow 
              ...
              label="사업 영역"
            >
              <ul className="list-disc list-outside pl-5 space-y-2 text-stone-700 dark:text-stone-400">
        ...
        {/* 하단 장식 요소 */}
        <div className="mt-16 text-center text-sm text-stone-400 dark:text-stone-600">
