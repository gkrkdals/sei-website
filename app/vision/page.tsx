  ...
  return (
    <div className="w-full bg-stone-50/30 py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-blue-950/5 border border-stone-100 overflow-hidden flex flex-col md:flex-row mb-16">
          {/* 왼쪽: 메인 사진 (정사각형) */}
          ...
          <div className="flex-1 p-8 lg:p-12 flex flex-col justify-center overflow-x-auto">
            <h2 className="text-2xl font-bold text-blue-900 mb-6 border-b border-blue-100 pb-4 inline-block self-start">
              에스이아이는(주)는
            </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-stone-100 flex flex-col items-center text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
            ...
            <div className="w-24 h-24 rounded-full bg-blue-950 p-3 flex items-center justify-center overflow-hidden mb-6 border-4 border-white shadow-md group-hover:border-blue-50 transition-colors shrink-0">
              {/* object-contain을 써서 투명 배경 이미지가 원 안에 쏙 들어오게 합니다. */}
              <img src="/images/vision2.png" alt="고객만족" className="w-full h-full object-contain" />
            </div>
            <h3 className="text-xl font-bold text-blue-900 mb-3">고객만족</h3>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-stone-100 flex flex-col items-center text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
            ...
            <h3 className="text-xl font-bold text-blue-900 mb-3">파트너쉽</h3>
            <p className="text-stone-600 font-medium leading-relaxed">
              튼튼한 협력관계<br />
              안정적인 공급처 확보
            </p>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-stone-100 flex flex-col items-center text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
            ...
            <h3 className="text-xl font-bold text-blue-900 mb-3">제품 품질</h3>
            <p className="text-stone-600 font-medium leading-relaxed">
              차별화 된 제품 공급<br />
              가격 경쟁력 보유
            </p>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-stone-100 flex flex-col items-center text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
            ...
            <h3 className="text-xl font-bold text-blue-900 mb-3">글로벌 네트워크</h3>
            <p className="text-stone-600 font-medium leading-relaxed">
              지속적인 해외 투자<br />
              해외 거래처 발굴
            </p>
