    ...
    <div className="w-full bg-stone-50/30 py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <section className="mb-16 md:mb-24">
          <div className="relative p-8 md:p-12 bg-white rounded-[2rem] border border-stone-100 shadow-2xl shadow-blue-900/5 overflow-hidden">
            {/* 배경 장식 요소 */}
            ...
            <div className="relative z-10 max-w-4xl">
              <h2 className="text-2xl md:text-4xl font-black text-stone-900 mb-6 tracking-tight break-keep leading-tight">
              ...
              <p className="text-lg md:text-xl text-stone-600 leading-relaxed font-medium break-keep">
                <span className="text-stone-900 font-bold">Audi, BMW, Stellantis Group, Toyota</span> 등 글로벌 자동차 브랜드의 휠 및 부품 마킹 분야에서 적용되는 
        ...
        <section className="flex flex-col gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-stone-100 flex flex-col lg:flex-row overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div className="p-6 lg:p-8 flex-1 flex flex-col justify-center gap-4">
              ...
              <div className="w-full rounded-xl overflow-hidden shadow-sm border border-stone-100">
                <img 
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-stone-100 flex flex-col lg:flex-row overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div className="p-6 lg:p-8 flex-1 flex items-center bg-blue-50/30">
              <p className="text-lg md:text-xl text-stone-700 leading-relaxed font-medium break-keep">
