    ...
    <div className="w-full flex flex-col items-center">
      ...
      <section className="w-full relative py-24 bg-blue-950 dark:bg-slate-950 text-white overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-8 leading-tight">
            첨단 정밀 기술•제품과 <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-white dark:from-blue-300 dark:to-blue-100">
      ...
      <section className="w-full max-w-6xl mx-auto px-6 py-24 -mt-10 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* 카드 2 */}
          <div className="bg-white dark:bg-slate-800 p-10 rounded-3xl shadow-xl shadow-stone-200/50 dark:shadow-black/50 border border-stone-100 dark:border-slate-700 hover:border-blue-200 dark:hover:border-blue-600 hover:shadow-2xl transition-all duration-300 group md:-translate-y-8">
            <div className="w-14 h-14 bg-blue-50 dark:bg-blue-950 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-blue-700 dark:group-hover:bg-blue-600 transition-all duration-300">
