        ...
        <nav className="hidden md:flex space-x-10 h-full">
          ...
          <div className="group relative h-full flex items-center">
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 w-56 bg-white/95 backdrop-blur-sm border border-stone-100 shadow-2xl rounded-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-4 group-hover:translate-y-2 overflow-hidden z-50 p-2">
              <Link href="/solutions/laser" className="block px-4 py-3 hover:bg-blue-50 hover:text-blue-700 text-sm font-medium rounded-xl transition-colors">레이저 장비</Link>
              <Link href="/solutions/inspection" className="block px-4 py-3 hover:bg-blue-50 hover:text-blue-700 text-sm font-medium rounded-xl transition-colors">검사 및 자동 포장라인</Link>
              <Link href="/solutions/pad-printing" className="block px-4 py-3 hover:bg-blue-50 hover:text-blue-700 text-sm font-medium rounded-xl transition-colors">패드인쇄기</Link>
              <Link href="/solutions/polishing" className="block px-4 py-3 hover:bg-blue-50 hover:text-blue-700 text-sm font-medium rounded-xl transition-colors">원심연마(광택)기</Link>
            </div>
          </div>
          ...
          <div className="group relative h-full flex items-center">
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 w-64 bg-white/95 backdrop-blur-sm border border-stone-100 shadow-2xl rounded-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-4 group-hover:translate-y-2 overflow-hidden z-50 p-2">
              <Link href="/products/silkscreen" className="block px-4 py-3 hover:bg-blue-50 hover:text-blue-700 text-sm font-medium rounded-xl transition-colors">실크스크린 잉크</Link>
              <Link href="/products/automotive" className="block px-4 py-3 hover:bg-blue-50 hover:text-blue-700 text-sm font-medium rounded-xl transition-colors">차량용 실크/패드프린팅 잉크</Link>
              <Link href="/products/electronic" className="block px-4 py-3 hover:bg-blue-50 hover:text-blue-700 text-sm font-medium rounded-xl transition-colors">전자기판용 잉크</Link>
              <Link href="/products/baby" className="block px-4 py-3 hover:bg-blue-50 hover:text-blue-700 text-sm font-medium rounded-xl transition-colors">유아/소아용 무독성 잉크</Link>
              <Link href="/products/films" className="block px-4 py-3 hover:bg-blue-50 hover:text-blue-700 text-sm font-medium rounded-xl transition-colors">PVC/PET/PC/PP 필름</Link>
            </div>
          </div>
        ...
        <div className="flex flex-col p-6 gap-2 max-h-[calc(100vh-5rem)] overflow-y-auto">
          ...
          <div className="border-b border-stone-100 py-3">
            ...
            <div className={`overflow-hidden transition-all duration-300 ease-in-out ${openAccordion === 'solutions' ? 'max-h-64 mt-4' : 'max-h-0'}`}>
              <div className="flex flex-col pl-4 gap-3 border-l-2 border-blue-100 text-stone-600 font-medium pb-2">
                <Link href="/solutions/laser" className="hover:text-blue-700 block">레이저 장비</Link>
                <Link href="/solutions/inspection" className="hover:text-blue-700 block">검사 및 자동 포장라인</Link>
                <Link href="/solutions/pad-printing" className="hover:text-blue-700 block">패드인쇄기</Link>
                <Link href="/solutions/polishing" className="hover:text-blue-700 block">원심연마(광택)기</Link>
              </div>
            </div>
          </div>
          ...
          <div className="border-b border-stone-100 py-3">
            ...
            <div className={`overflow-hidden transition-all duration-300 ease-in-out ${openAccordion === 'products' ? 'max-h-80 mt-4' : 'max-h-0'}`}>
              <div className="flex flex-col pl-4 gap-3 border-l-2 border-blue-100 text-stone-600 font-medium pb-2">
                <Link href="/products/silkscreen" className="hover:text-blue-700 block">실크스크린 잉크</Link>
                <Link href="/products/automotive" className="hover:text-blue-700 block">차량용 실크/패드프린팅 잉크</Link>
                <Link href="/products/electronic" className="hover:text-blue-700 block">전자기판용 잉크</Link>
                <Link href="/products/baby" className="hover:text-blue-700 block">유아/소아용 무독성 잉크</Link>
                <Link href="/products/films" className="hover:text-blue-700 block">PVC/PET/PC/PP 필름</Link>
              </div>
            </div>
          </div>
